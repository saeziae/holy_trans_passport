def main(file,bc=None):
    ...
    qr.make(fit=True)
    f_number = ImageFont.truetype("no-font.ttf", size=50)
    f_text = ImageFont.truetype("text-font.ttf", size=34)
    ...
    imd.text((500, 304), info["name"], font=f_text, fill=(0, 0, 0))
    imd.text((1004, 304), info["pronouns"], font=f_text, fill=(0, 0, 0))
    imd.text((500, 521), birth, font=f_text, fill=(0, 0, 0))
    imd.text((1004, 521), info["place"], font=f_text, fill=(0, 0, 0))
    imd.text((500, 630), issue, font=f_text, fill=(0, 0, 0))
