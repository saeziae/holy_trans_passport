def main(file,bc=None):
    ...
    f_text = ImageFont.truetype("text-font.ttf", size=32)
    ...
    imd.text((1004, 308), info["pronouns"], font=f_text, fill=(0, 0, 0))
    imd.text((500, 524), birth, font=f_text, fill=(0, 0, 0))
    imd.text((1004, 524), info["place"], font=f_text, fill=(0, 0, 0))
    imd.text((500, 633), issue, font=f_text, fill=(0, 0, 0))
